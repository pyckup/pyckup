...
- Create a branch of the 'dev' branch
  -  **for features**: use name 'feat/<issue_number>/<descriptive_feature_name>
  -  **for bug fixes**: use name 'fix/<issue_numer>/<descriptive_bug_name>
- implement your changes on the new branch
- Create a pull request to 'dev' using the PR template
